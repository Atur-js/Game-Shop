                    ...
                    <div className="col-sm-9 p-3"  >
                        ...
                        { checkout && 
                            <div className="p-3 text-center text-success">
                                <button style={{color:"black",border:"none",borderRadius:"5px",backgroundColor:"yellow"}}>Checkout successfull</button>
                                <br/>
                                <Link to="/" className="btn btn-outline-success btn-sm" style={{color:"black",backgroundColor:"white",border:"none",borderRadius:"5px",marginTop:"5px"}}>BUY MORE</Link>
                            </div>
                        }
                    </div>
                    {
